  ...
  try {
    ...
    if (order.dispute_status === "open") {
      return NextResponse.json(
        {
          error:
            "No se puede liberar el pago con una disputa abierta",
        },
        { status: 400 }
      );
    }
    ...
    if (
      ...
      return NextResponse.json(
        {
          error:
            "El vendedor no tiene cuenta Stripe conectada",
        },
        { status: 400 }
      );
    }
      ...
      .insert([
        {
          ...
          type: "sale",
          title:
            sellerT.releasePaymentSellerTitle,
          message:
            sellerT.releasePaymentSellerMessage,
          link: "/orders",
          is_read: false,
        },
        {
          ...
          type: "order",
          title:
            buyerT.releasePaymentBuyerTitle,
          message:
            buyerT.releasePaymentBuyerMessage,
          link: "/orders",
          is_read: false,
        },
      ]);
