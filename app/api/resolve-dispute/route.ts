  ...
  try {
    ...
    if (
      ...
      return NextResponse.json(
        {
          error:
            "La disputa ya ha sido resuelta",
        },
        { status: 400 }
      );
    }
    ...
    if (
      ...
      return NextResponse.json(
        {
          error:
            "El pago al vendedor ya ha sido liberado",
        },
        { status: 400 }
      );
    }
      ...
      if (
        ...
        if (
          ...
          return NextResponse.json(
            {
              error:
                "Importe del vendedor no válido",
            },
            { status: 400 }
          );
        }
        ...
        if (
          ...
          return NextResponse.json(
            {
              error:
                "Falta la cuenta de Stripe del vendedor",
            },
            { status: 400 }
          );
        }
      ...
      .insert([
        {
          ...
          type: "dispute",
          title:
            buyerT.disputeResolvedNotificationTitle,
          message:
            resolution ===
            "buyer_refund"
              ? buyerT.disputeBuyerRefundNotificationMessage
              : buyerT.disputeBuyerSellerWinsNotificationMessage,
          link: "/orders",
          is_read: false,
        },
        {
          ...
          type: "dispute",
          title:
            sellerT.disputeResolvedNotificationTitle,
          message:
            resolution ===
            "seller_wins"
              ? sellerT.disputeSellerWinsNotificationMessage
              : sellerT.disputeSellerBuyerRefundNotificationMessage,
          link: "/orders",
          is_read: false,
        },
      ]);
    ...
    if (
      !finalOrder ||
      finalOrder.dispute_status !==
        "resolved"
    ) {
      return NextResponse.json(
        {
          error:
            "No se pudo verificar la actualización de la disputa",
          order: finalOrder,
        },
        { status: 500 }
      );
